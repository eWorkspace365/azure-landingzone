Configuration AzureDSCforWIN2022
{
	...
	
	{
		...
		Registry 'Registry(POL): HKLM:\SOFTWARE\Microsoft\Cryptography\Wintrust\Config\EnableCertPaddingCheck'
		{
			Ensure      = 'Present'
		...
		Registry 'Registry(POL): HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\DNSClient\DoHPolicy'
		{
			Ensure      = 'Present'
		...
		Registry 'Registry(POL): HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\DNSClient\EnableNetbios'
		{
			Ensure      = 'Present'
			Key         = 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows NT\DNSClient'
		...
		Registry 'Registry(POL): HKLM:\SYSTEM\CurrentControlSet\Control\Print\RpcAuthnLevelPrivacyEnabled'
		{
			Ensure      = 'Present'
		...
		Registry 'Registry(POL): HKLM:\SOFTWARE\Policies\Microsoft\Windows\Group Policy\{827D319E-6EAC-11D2-A4EA-00C04F79F83A}\NoBackgroundPolicy'
		{
			Ensure      = 'Present'
		...
		Registry 'Registry(POL): HKLM:\SOFTWARE\Policies\Microsoft\Windows\Group Policy\{827D319E-6EAC-11D2-A4EA-00C04F79F83A}\NoGPOListChanges'
		{
			Ensure      = 'Present'
			Key         = 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Group Policy\{827D319E-6EAC-11D2-A4EA-00C04F79F83A}'
			ValueName   = 'NoGPOListChanges'
		...
		Registry 'Registry(POL): HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection\NoBackgroundPolicy\DisableOneSettingsDownloads'
		{
			Ensure      = 'Present'
			Key         = 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DataCollection'
	...
	Script AddASRExclusions
         {
            SetScript = {
                Add-MpPreference -AttackSurfaceReductionOnlyExclusions "C:\Windows\System32\Wbem\wmiprvse.exe"
                Add-MpPreference -AttackSurfaceReductionOnlyExclusions "C:\Windows\Microsoft.NET\Framework64\*\csc.exe"
		Add-MpPreference -AttackSurfaceReductionOnlyExclusions "C:\Windows\System32\SecEdit.exe"
		Add-MpPreference -AttackSurfaceReductionOnlyExclusions "C:\Windows\System32\conhost.exe"
		Add-MpPreference -AttackSurfaceReductionOnlyExclusions "C:\Windows\System32\auditpol.exe"
		Add-MpPreference -AttackSurfaceReductionOnlyExclusions "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe"
         }
            TestScript = {
                $exclusions = (Get-MpPreference).AttackSurfaceReductionOnlyExclusions
                $exclusions -contains "C:\Windows\System32\Wbem\wmiprvse.exe" -and $exclusions -contains "C:\Windows\Microsoft.NET\Framework64\*\csc.exe" -and $exclusions -contains "C:\Windows\System32\SecEdit.exe" -and $exclusions -contains "C:\Windows\System32\conhost.exe" -and $exclusions -contains "C:\Windows\System32\auditpol.exe" -and $exclusions -contains "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe"
            }
            GetScript = {
                @{ Result = 'Success' }
            }
...
AzureDSCforWIN2022 -OutputPath 'C:\Users\Administrator\Output'
