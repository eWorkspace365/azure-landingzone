...
Function Connect_Exo
{
 ...
 if(($AdminName -ne "") -and ($Password -ne ""))
 {
  ...
  Connect-ExchangeOnline -CertificateThumbPrint "81F9A38A7EAF222293BA9ACF94EB32C03E8E0D8B" -AppID "3ef972b6-883c-4b38-918e-fe113b1859ec" -Organization "odregioarnhem.onmicrosoft.com"
 }
 else
 {
  Connect-ExchangeOnline -CertificateThumbPrint "81F9A38A7EAF222293BA9ACF94EB32C03E8E0D8B" -AppID "3ef972b6-883c-4b38-918e-fe113b1859ec" -Organization "odregioarnhem.onmicrosoft.com"
