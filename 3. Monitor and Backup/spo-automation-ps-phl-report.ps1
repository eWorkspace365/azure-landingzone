...
$SiteCollAdmin = "ict@domain.com"
 
$AppID = "<app-id>"
$CertificateThumbPrint = "<thumbprint>"
$Organization = "tenantname.onmicrosoft.com"
 
Connect-PnPOnline -Url $AdminSiteURL -ClientId $AppID -Thumbprint $CertificateThumbPrint -Tenant $Organization
...
{
    Connect-PnPOnline -Url $SiteURL -ClientId $AppID -Thumbprint $CertificateThumbPrint -Tenant $Organization -ErrorAction Stop
